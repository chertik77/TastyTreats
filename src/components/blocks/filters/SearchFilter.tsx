    ...
    <label className='flex flex-col text-fs-12-lh-normal-fw-400 text-dark-50 dark:text-gray-50'>
      ...
      <span className='p-input-icon-left mt-2'>
        ...
        <AutoComplete
          ...
          inputClassName='w-[335px] h-[46px] border border-dark-20 rounded-[15px] py-[14px] px-[48px] placeholder:text-dark-50 placeholder:fs-14-lh-normal-fw-500 focus:outline-none focus:shadow-none text-dark-50 dark:bg-transparent dark:border-gray-20 dark:placeholder:text-gray-50 dark:text-gray-50 tablet:w-[248px] tablet:h-[48px]'
